      ...
      <div className="max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-3 pt-4">
            <a
              href="#projects"
              className="btn-accent px-6 py-3 rounded-full text-sm font-semibold flex items-center gap-2"
            >
            ...
            <a
              href="#contact"
              className="glass-panel glass-panel-hover px-6 py-3 rounded-full text-sm font-semibold text-white flex items-center gap-2"
            >
