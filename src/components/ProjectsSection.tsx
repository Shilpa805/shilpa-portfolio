...
import { ExternalLink, Sparkles, BookOpen, ArrowUpRight } from "lucide-react";
  ...
  return (
    <section id="projects" className="py-24 px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="max-w-6xl mx-auto space-y-20">
        ...
        {/* Projects List (Alternating Left-Right Layout) */}
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center gap-3 pt-2">
                    <a
                      ...
                      className="btn-accent px-5 py-2.5 rounded-full text-xs font-semibold flex items-center gap-1.5"
                    >
                      <span>Live Demo</span>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="glass-panel glass-panel-hover px-5 py-2.5 rounded-full text-xs font-semibold text-white flex items-center gap-1.5"
                    >
